...
function actionmenu(spn)
{
    ...
    var str = "<table cellpadding=2 cellspacing=1 style=\"color:white;font-family:" + defaultfontfamily + "\" >" + allainputeles 
