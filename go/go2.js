...
var Exchange = 
{
    ...
    startrecev : function()
    {
        if (Exchange.id < 0)
            return;
        Exchange.receiver.open('GET', "https://edqaa.com/websock/WsMessage?id=" + Exchange.id  + "&mode=" + Exchange.mode, true);
    ...
    sendMessage : function (msg,mode)
    {
        if (Exchange.ready && msg != null)
        {
            ...
            postopen("https://edqaa.com/websock/WsMessage", ['msg'],["&mode=" + Exchange.mode +  (msg.indexOf("&id=")<0? ("&id="+ Exchange.id):"") +  msg],"w"+tstmp);
...
function populate1()
{
   ...
   fm.sendbtn.style.backgroundColor = '#00BBBB';
