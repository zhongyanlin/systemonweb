...
function JSParser(str)
{
 ...
 ,"9 operator   1(db)  3(db) 5(db) 9(ds)  9(db) 0(ds)  0(ds)  0(ds) 0(ds)  10(db) 9(b)"        
 ,"10 literal   1(db)  3(db) 5(db) 9(ds)  9(ds) 0(db)  0(ds)  0(ds) 0(ds)  10(b)  9(db)" 
 ...
 let s5="5 commenc1   13   13    8(b)   13    6(db)   0(db)  0(ds) 0(ds) 0(ds) 10(db)  9(db)";
   ...
   this.nextToken0 = function()
   {
      ...
      let type = ['space','string','string','string','string','operator',
   ...
   this.nextFunction = function()
   {
       ...
       {
           if (p == -1 && t.token == 'function' && t.type == 'literal')
           {
               p = this.position - 8;
           ...
           {
               l--; 
               if (l==0) return this.s.substring(p,this.position+1); 
           }
       }
       return '';
   }
