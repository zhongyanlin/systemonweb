...
/*208*/"Receipt Number.",
/*209*/"You are not done yet!  After you upload all files, you need to click the",
...
/*235*/"is closed and the system does not accept submission for this assignment/test. Ask your instructor for any question.",
/*236*/"Pending",
/*237*/"Commit",
...
/*900*/"The following files have not been moved successfully. It is likely the same-name file exists in the destination folder",
...
/*1259*/"items and  sum the rest@Normalization formula",
/*1260*/"Parentheses",
/*1261*/"Style",
...
/*1354*/"looks like a separate question, but there is no blank line before it. Is it really a question?",
...
/*1567*/"Apply the Curve Formula@Keep the comments made before",
...
/*1617*/"Submit another one@Grade this one now@Grade",
/*1618*/"Submit",
/*1619*/"Calculate",
...
/*1636*/"Compose",
/*1637*/"Incomplete answers were found in the cache. You may send them to the instructor by clicking the link below. Depending on the policy, the instructor may or may not accept overdue course work.",
/*1638*/"None incomplete answer can be found on this computer. You may try to search other computers that were used to answer the questions",
...
/*1866*/"Sent@Saved@Some records failed to be saved. Click Save button to try again.@Cached@Saved@Shuffle",
/*1867*/"Shuffled@Estimated@Parsed",
...
/*1892*/"Functions and Features@Facilitate   Go, Gobang, and Tictactoe@Allow to query multiple players  to pair up@Allow to negotiate time limit@Allow to exchange messages during game@Takes away contained stones automatically@Show minute and second timers of both players@Allow to count stones instantly@Archive games(see  Archive|Download|Restore)@Resume a game from crush or disconnection@Allow to broadcast your game and watch games@Provide animation to study related algorithm</ol>",
...
/*1894*/"Message transmission stoped. Any more student answering questions?",
/*1895*/"Your question has been sent to teaching staff. You may answer other questions first while you wait for reply",
/*1896*/"No agent created in the memory of server until the first tester trigs one",
/*1897*/"Agent in Server Memory",
/*1898*/"Distribution",
/*1899*/"If no quiz is active, you have to delete the agent.",
/*1900*/"Analytics",
/*1901*/"By Question",
/*1902*/"About",
/*1903*/"Alert",
/*1904*/"Preserved order when shuffling",
/*1905*/"3<4 means question 4 goes right after 3",
/*1906*/"For production, multiple-choices go first, and filling-blanks follow",
/*1907*/"Regression",
/*1908*/"Finding",
/*1909*/"Examples of boolean expressions@Possibly imply@Whom copy homework@Whom Study hard@Plot@Boolean Expression@Use these field names to compose expression@To find",
/*1910*/"TestScore",
/*1911*/"WorkTime",
/*1912*/"OpenCount",
/*1913*/"SubmitCount",
...
/*1915*/"Attendance",
/*1916*/"Average",
/*1917*/"For @ increases by @, @ increases by @",
/*1918*/"TryAgain@Database was busy",
/*1919*/"AnswerOrder",
/*1920*/"Raw Data",
/*1921*/"Extend due time for this student  to:",
/*1922*/"Number of Decimals",
/*1923*/"This Set of Course Sessions@This Assignment@Use the records and your own policy to determine if offer an extention@In the blank cell enter ID of students whom your offer an extension and press the Tab key@Delay Times@Total Days",
/*1924*/"Anonymous Grading",
/*1925*/"Same response for the rest",
/*1926*/"Hide@Show",
/*1927*/"No access control@Require attendance@Uniform passcode@Distinct passcode@Manage Codes@Need to distribute  a paper slip of distinct code to each student  in the room in person. Each code is valid for a single student to do one-time submission only@Optionally assign code to student Id@Generate@Random Code@Please enter passcode",
/*1928*/"Instructions: (1)Before the class starts, generate class-size many random codes, save them and print them out and cut the paper into paper slips, each containing one code. (2)Distribute one code to each student in person in classroom right before the test starts. When prompting for a code during the test, students enter the code. (3)In case printed codes are not enough, generate a few more and tell the students in person. (4) Some cheating students may pass their own code to remote cheating accomplice using instant messager, then claim they have just lost the code, and request another one from you. In such a case, you can generate and re-issue a code, but  need to take attendance and  check if the absent student is using a code from the following list. After identifying  the remote cheating students, you may use the \"void\"  function in the proctoring service to stop and warn them.",
/*1929*/"Instructions: The following students have absence records in pass@minutes. But if they have showed up, erase their absence records and update. On the other hand, if more students are absent now, enter their ids and update@If you were late but now are in the classroom, ask instructor/proctor to delete your record of absence@Absence Records@Password",
/*1930*/"Students can take this test remotely without any restriction@Take attendance before the tests starts.Absent students can not open the test@Announce the  access code in classroom.Warning:cheaters can pass the code to remote accomplices@Distribute distinct codes to students using paper slip, each being good for one student for one test",
/*1931*/"Because of low  attendance,insufficient submission of course work, or low test scores, you are risking failing this course. Please seek help from your Instructor as early as possible",
/*1932*/"Swap",
/*1933*/"Midexam@Final Exam",
/*1934*/"Zone",
/*1935*/"Load answers@Load cached@Do not load answers@Synchronize answer editing@Use these answers to overwrite the text in the answer box on the Assignment editing page? @The answer has been synchronized to the answer box on the edit page",
/*1936*/"Are you entering Tex codes? If yes, pairs of currency signs ($) are required to enclose Tex codes or your answer will be judged as INCORRECT@Are Tex codes rendered correctly?@If not, please edit the codes again",
/*1937*/"Similarity@Disclaim: As a reference, Levenshtein score is only one type measurement of string distance, by no means it is a sole base for grading@For filling-blank questions, do you want to use Levenshtein score",
/*1938*/"files downloaded",
/*1939*/"After submitting the test, show the proctor the receipt of submission before you leave the classroom. Any submission made outside of the classroom is invalid and will result in score zero",
/*1940*/"Grade Project",
/*1941*/"Grades Released",
/*1942*/"Next@Feedback@Feedback Mode@This grading feedback may imply a misgrading for all submission to this question. In such a case, you may want to load all submissions to this question to fix the grading. Do you want to load all submissions or just the ones with feedback?@Load all@Load feedback only",
/*1943*/"Distinct@Click &#9998; to write uniform comments for a <b>same-answer</b> submission group@+ to expand a group to add comments for individual student @'Save' button to  upload partial grading to the server, or @'Update' button to cache locally  until you complate all then click the 'Save'  button@Grade@Comments@Average@Distinct Answer@Grading not updated yet. Update or close again to abandon@Entered comment  has not been used. Click Cancel again to abandon it@After entering score in the Grade box hit Enter key to navigate quickly@Selected@Grading",
/*1944*/"Submission@Recover@Cache  Time@Cached Grade@Cached Grading@Cached Comments @Current Grade@Current Grading@Current Comments@Cached: records in local non-volatile storage that may not exist on the server@Current: records in  volatile memory or on server@Clear: delete obsolete records@Recover: copy cache to fill out or replace current records",
/*1945*/"Clipboard"];
