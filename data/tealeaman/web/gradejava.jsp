...
if (File.separator.equals("/")) {
    ...
    if (javacpath == null)
    {
        ...
        for(String yy:ff.list()) if (yy.contains("jdk")){javacpath = "C:\\Program Files\\Java\\" + yy;break;}
    }
    if (javacpath == null || javacpath.equals("")) 
    {
        out.println("No Java or Javac");
        return;
    }
...
try {
    ...
    if (exitVal != 0) {
        out.println("Error: Compilation failed"+inputmsg + "<br>" + sb.toString() );
        out.close();
