...
function compsubmis()
{
     ...
     + '</select></td></tr><tr>'
     + '<td  colspan="2" align=center bgcolor=' + TBGCOLOR +'><input class=OrangeButton style="width:70px;text-align:center" value="'
...
function thisisnot(td)
{
   ...
   for (var i=0; i < tbl.rows.length; i++)
   {
       if (tbl.rows[i].cells[4]==td)
       {
            ...
            compsubmisresu.parentNode.parentNode.parentNode.childNodes[1].childNodes[0].innerHTML
            = "<table><tr><td>&nbsp;<br></td></tr></table>";
            setRoundedSize(promptwin,
            (compsubmisresu.parentNode.parentNode.parentNode.offsetWidth + 6), 
            (compsubmisresu.parentNode.parentNode.parentNode.offsetHeight + 6) );
...
function compsubmisvew(i,j,alink)
{
   ...
   while (ai < a.length && bi < b.length)
   {
      ...
      if (k < b.length)
      {
         at += "<nobr><span style=background-color:" + BBGCOLOR+">" + a[ai].replace(/</g, "&lt;") + "</span></nobr><br>";
         matchn++;
         bi++;
      }
      else
   ...
   {
      if (c[k]==true)
        bt += "<nobr><span style=background-color:" + BBGCOLOR+">" + b[k].replace(/</g, "&lt;")  + "</span></nobr><br>";
      else if (b[k]!='')
   ...
   compsubmisresu.parentNode.parentNode.parentNode.childNodes[1].childNodes[0].innerHTML
      ...
      + "<tr><td colspan=2 align=center bgcolor=" + BBGCOLOR +">" + textmsg[911] + ": <b>" + matchn + "</b>  &nbsp;&nbsp;" + mat[i][10] +": <b>" + Math.floor(matchn/blankar*100) +"%</b>  &nbsp;&nbsp;" + mat[j][10] +": <b>"
